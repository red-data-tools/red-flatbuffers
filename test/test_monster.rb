...
class TestMonster < Test::Unit::TestCase
  ...
  def test_color
    assert_equal(["Blue"], @monster.color.names)
  end
  ...
  def test_test_array_of_strings2
    assert_nil(@monster.testarrayofstring2)
  end
  ...
  def test_test4
    assert_equal([
                 ...
                 @monster.test4.collect {|test| {a: test.a, b: test.b}})
  end
  ...
  def test_test5
    assert_equal([
                 ...
                 @monster.test5.collect {|test| {a: test.a, b: test.b}})
  end
  ...
  def test_test_hash_s32_fnv1
    assert_equal(-579221183, @monster.testhashs32_fnv1)
  end

  def test_test_hash_u32_fnv1
    assert_equal(3715746113, @monster.testhashu32_fnv1)
  end

  def test_test_hash_s64_fnv1
    assert_equal(7930699090847568257, @monster.testhashs64_fnv1)
  end

  def test_test_hash_u64_fnv1
    assert_equal(7930699090847568257, @monster.testhashu64_fnv1)
  end

  def test_test_hash_s32_fnv1a
    assert_equal(-1904106383, @monster.testhashs32_fnv1a)
  end

  def test_test_hash_u32_fnv1a
    assert_equal(2390860913, @monster.testhashu32_fnv1a)
  end

  def test_test_hash_s64_fnv1a
    assert_equal(4898026182817603057, @monster.testhashs64_fnv1a)
  end

  def test_test_hash_u64_fnv1a
    assert_equal(4898026182817603057, @monster.testhashu64_fnv1a)
  end
  ...
  def test_test_f2
    assert_equal(3.0, @monster.testf2)
  end

  def test_test_f3
    assert_equal(0.0, @monster.testf3)
  end
  ...
  def test_long_enum_non_enum_default
    assert_equal(MyGame::Example::LongEnum.new(0),
                 @monster.long_enum_non_enum_default)
  end
  ...
  class TestVec3 < self
    ...
    def test_test1
      assert_equal(3.0, @vec3.test1)
    end

    def test_test2
      assert_equal(["Green"], @vec3.test2.names)
    end

    def test_test3
      assert_equal(5, @vec3.test3.a)
    end
  end
